...
{
    private const string IRequestMetadata              = "HermesMediator.IRequest`1";
    private const string IRequestHandlerMetadata       = "HermesMediator.IRequestHandler`2";
    private const string IStreamRequestMetadata        = "HermesMediator.IStreamRequest`1";
    private const string IStreamRequestHandlerMetadata = "HermesMediator.IStreamRequestHandler`2";
