...
/// <summary>
/// Registry mutável de wrappers — populado durante o AddHermes() e
    ...
    internal RequestHandlerWrapperBase GetRequestWrapper(Type requestType)
    {
        ...
        if (!dict.TryGetValue(requestType, out var wrapper))
            throw new InvalidOperationException(
                ...
                $"Verifique se o assembly foi incluído em AddHermes() ou se existe um IRequestHandler<{requestType.Name},...>.");
        return wrapper;
    }
