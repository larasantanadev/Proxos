...
/// <summary>
/// API de infraestrutura usada pelo código gerado pelo Hermes.Generator.
/// Não chame diretamente — use <c>AddHermes()</c> ou <c>AddHermesGenerated()</c>.
/// </summary>
[EditorBrowsable(EditorBrowsableState.Never)]
public static class HermesRegistrar
{
    /// <summary>
    /// Obtém o <c>WrapperRegistry</c> singleton registrado pelo <c>AddHermes()</c>.
